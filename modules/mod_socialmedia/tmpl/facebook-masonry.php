						...
						<div class="social-media-masonry__card-footer-icons setting-text">
							<span class="social-media-masonry__card-footer-icon-container">
								<svg xmlns="http://www.w3.org/2000/svg" fill="#666666" viewBox="0 0 512 512" alt="thumbs up icon"
									class="social-media-masonry__card-footer-icon">
									<path
								...
								<strong class="social-media-masonry__card-footer-likes"><?php echo $post->likes ?></strong>
							</span>
							<span class="social-media-masonry__card-footer-icon-container">
								...
								<strong class="social-media-masonry__card-footer-comments"><?php echo $post->comments ?></strong>
							</span>
						</div>
					</div>
					<?php endif;?>
